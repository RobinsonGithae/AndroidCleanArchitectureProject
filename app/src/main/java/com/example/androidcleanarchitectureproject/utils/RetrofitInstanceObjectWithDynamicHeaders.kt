...
@Singleton
class RetrofitInstanceObjectWithDynamicHeaders @Inject constructor(private  val dataManager: DataManager) {


    /** Define a client with both api requests and logging interceptors here by chaining the interceptors **/
    val client= OkHttpClient.Builder().apply {
        addInterceptor(ApiInterceptorWithDynamicHeaders(dataManager)) /** first interceptor to add app api request headers **/
